...
# Skills
  ...
  * Advanced statistical analysis
    - Multi-level modelling, structural equation modelling, general linear modelling, generalised linear models
  * Research methods
  * R programming
    - `lavaan`, `psych`, `lme4`, `papaja`, `xaringan`, `blogdown`, & `tidyverse`
